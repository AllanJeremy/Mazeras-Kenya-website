<?php
  ...
  $GLOBALS["active_page"] = "company";#Set the active page
  $GLOBALS["page_title"] = "Company | ".ucwords($GLOBALS["company_name"]);
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body>
    ...
    <div class="container-fluid header-image qtr-height" id="<?php echo GetHeaderImageId();?>">
      ...
      <div class="header-content text-white text-center">
        <h1>DELIVERING A GREAT EXPERIENCE</h1>
        <h3 class="lead pt-2 pb-2">We mine and sell mazeras stones in wholesale</h3>
      </div>
    </div>
